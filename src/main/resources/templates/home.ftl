...
<header class="header">
    <div class="header-inner body-width">
        ...
        <div class="search">
            <input type="text" class="search-text" placeholder="请输入查询内容...">
...
<div class="main">
    <div class="main-inner body-width">
        ...
        <div class="main-cont main-user">
            ...
            <ul class="main-cont__list clearfix">
                <li class="item">
                    <a href="#" class="pic" style=" background: url(img/cont/user_img1.jpg) no-repeat; background-size: cover; "></a>
                ...
                <li class="item">
                    <a href="#" class="pic" style=" background: url(img/cont/user_img2.jpg) no-repeat; background-size: cover; "></a>
                ...
                <li class="item">
                    <a href="#" class="pic" style=" background: url(img/cont/user_img3.jpg) no-repeat; background-size: cover; "></a>
                ...
                <li class="item">
                    <a href="#" class="pic" style=" background: url(img/cont/user_img4.jpg) no-repeat; background-size: cover; "></a>
                ...
                <li class="item">
                    <a href="#" class="pic" style=" background: url(img/cont/user_img5.jpg) no-repeat; background-size: cover; "></a>
...
<footer class="footer">
    <div class="footer-container">
        <div class="footer-link">
            ...
            <div class="footer-link__item">
                <div class="footer-orcode"><img src="img/app_qrcode.png" alt="#"></div>
